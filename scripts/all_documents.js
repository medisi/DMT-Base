const defaultSettings = {
    ...
    fontFamily: 'Roboto',
    fontSize: '16',
    panelVisible: 'visible' // по умолчанию
};
...
//     const listValueEditSelect = editInputAll.value;
//     const listValueEdit = editInput.value;
//     const listsEdit = document.querySelectorAll('#select-list option');
...
//                 document.getElementById('edit-all-list').value = optionEdit.textContent;
//                 editListAll.style.display = 'none';
//             });
//             editListAll.appendChild(cellEditItem);
//         };
//     });
//     editListAll.style.display = hasMatchesEdit ? 'block' : 'none';
// });
// Редактирование названия списка
function editNameList() {
